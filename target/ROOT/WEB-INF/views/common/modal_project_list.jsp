...
<style>
	...
	/* modal */
	.modal{display:none; position:fixed; top:0; left:0; z-index:1050; width:100%; height:100%;overflow: auto;}
	.modal .bg{position:fixed; top:0; left:0; width:100%; height:100%; opacity:.4; background:#2c2c2c;}
	.modal-inner{position:absolute; top:50%; left:50%; }
	.modal h1{padding:10px 0 15px 5px; font-size:38px; font-weight:normal; color:#414141;}
	.modal input[type="text"],
	.modal input[type="password"]{width:100%; height:48px; box-sizing:border-box; margin:0 0 5px; padding:15px 30px; font-size:14px; border:0; background:#fff;}
	.modal .btn{display:block; width:100%; height:48px; font-size:15px; text-align:center; line-height:48px; color:#fff; background:#a4a4a4;}
	.modal .btn-close{position:absolute; top:0; right:0;}
	.modal .btn-facebook{width:100%; height:48px; font-size:15px; color:#fff; background:#3b5998;}
	.modal .btn-regi{float:right; width:75px; height:28px; font-size:15px; color:#fff; border-radius:5px; background:#113b88;}

	.padding_zero{padding:0px;}
	.background_none{background: none; border:none;}
	.red_underline{border-bottom: 1px solid red;}
	.modal-inner h1{border-bottom: 1px solid red; margin-bottom: 20px;}
	.modal input[type="text"],
	.modal input[type="password"]{width:100%; height:48px; box-sizing:border-box; margin:0 0 5px; padding:15px 30px; font-size:14px; border:0px; background:white;}
	.modal .btn-regi{float:right; width:75px; height:28px; font-size:15px; color:#fff; border-radius:5px; background:red;}
	.modal .btn-close{position:absolute; top:0; right:0; padding:0px;}
	.file button{width:80px; height:27px; box-sizing:border-box; padding:0 0 0 22px; font-size:15px; color:#fff; border-radius:7px; background:red; url(../image/sub/blt_search.png) no-repeat 14px 5px;}
	#modify-topic .btn-add{float:none; width:65px; height:28px; font-size:15px; line-height:28px; color:#fff; border-radius:5px; background:red;}

	<!-- 프로젝트 상세 -->
	#project-detail .modal-inner{top:10%; width:956px; margin:0 0 50px 0px; padding:20px 45px; color:#686868; background:#fff;}
	...
	#project-detail .btn-modi{background:url(/resources/image/sub/blt_modi.png) no-repeat 0 0;}
	#project-detail .btn-del{background:url(/resources/image/sub/blt_trash.png) no-repeat 0 0; margin-bottom: 10px;}
	#project-detail .img{margin:0 0 6px; border-bottom:1px solid red;}
	...
	#project-detail .img .btn-like{padding:0 0 0 25px; background:url(/resources/image/sub/blt_heartGray.png) no-repeat 0 0;}
	#project-detail .img .btn-like.active{padding:0 0 0 25px; background:url(/resources/image/sub/blt_heartGray_active.png) no-repeat 0 0;}
	#project-detail .img .btn-share{padding:0 0 0 30px; background:url(/resources/image/sub/blt_share.png) no-repeat 0 0;}
	#project-detail .img .btn-down{padding:0 0 0 30px; background:url(/resources/image/sub/blt_down.png) no-repeat 0 0;}
	#project-detail textarea{width:100%; height:80px; margin:0 0 6px; box-sizing:border-box; padding:12px; font-size:12px; border:1px solid red;}
	...
	.btn-cmmt{float:right; width:75px; height:28px; font-size:15px; color:#fff; border-radius:5px; background:red;}
	...
	#new-topic .btn-add{float:none; width:65px; height:28px; font-size:15px; line-height:28px; color:#fff; border-radius:5px; background:red;}
</style>

<!-- 닫기 버튼 (close button / button close) -->
<script>
    $(function(){
...
<div class="modal" id="project-detail">
	...
	<div class="modal-inner">
		...
		<div style="height:30px;">
			<p class="opinion" style="word-break:break-all;" data-nm="contents">{{:contents}}</p>
			<div class="btn-set">
				{{if <%=isProjNotComplete%> &&  curUserAuthYN }}
			<!--	<a href="javascript:goWorkModView();" class="btn-modal btn-modi" data-nm="btnMod"  >수정</a>-->
				<a href="javascript:projDetailDelWork();" class="btn-modal btn-del"  data-nm="btnDel" style="float:right; color:red; margin-right:20px"  >삭제</a>
				{{/if}}
		...
		<div class="img">
			...
			<div>
				...
				<button type="button" class="btn-like background_none" onclick="projDetailWorkLike(this);"><span class="like">좋아요</span></button>
				{{else}}
				...
				<button type="button" class="btn-down background_none" onclick="projDetailImgDown();"  >다운로드</button>
			</div>
		</div>
		...
		<button type="button" class="btn-close background_none"><img src="/resources/image/common/btn_close.gif" alt="닫기"></button>
	</div>
</div>
</script>
...
<div class="modal" id="upload-modal">
	<div class="bg"></div>
	<div class="modal-inner" style="width:690px;height:600px; padding-top:0px;"> <!-- 수정  -->
		<h1>디자인 업로드</h1>
		<form name="NewUpForm" method="post" enctype="multipart/form-data" onsubmit="return false;" >
			...
			<fieldset>
				...
				<textarea name="contents"  maxlength="1000" placeholder="디자인 설명 (최대 1000자)"></textarea>
				<button type="button" class="btn-cmmt" onclick="newUpFormSubmit();">등록</button>
			</fieldset>
		</form>
		<button type="button" class="btn-close background_none">

		<img style="background:base-color" src="/resources/image/common/btn_close.gif" alt="닫기">   </button>
	</div>
</div>
</script>
<script>
