...
<style>
    ...
    .file button{width:80px; height:27px; box-sizing:border-box; padding:0 0 0 22px; font-size:15px; color:#fff; border-radius:7px; background:#b5b5b5 url(/resources/image/sub/blt_search.png) no-repeat 14px 5px; border: 0px;0}
    ...
    .regi-content .btn-complete{float:right; width:200px; height:64px; font-size:24px; color:#fff; text-align:center; line-height:64px; border-radius:7px; background:red; border: 0px;}
    ...
    <div class="content regi-content">
        <div class="container">
            <div class="container maintitle mb-5" >
                ...
                <span class="maintitle2">새디자인 등록</span>
            </div>
            <form name="productForm" id="productForm" enctype="multipart/form-data" onsubmit="return false;" >
                <table class="tbl-regi">
                    ...
                    <tr style="display:none">
                        <th scope="row">원본 디자인</th>
                        <td colspan="3"><input id="origin_text" type="text" name="origin"></td>
                    </tr>                    
                    <tr>
                        <th scope="row" class="km-required">디자인명</th>
                        <td colspan="3"><input type="text" name="title" maxlength="50" placeholder="최대 50자 이내 입력" class="no-border" style="width: 550px;"></td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3" id="cateWrapProdRegi" >
                            ...
                            <ul id="ul_cate_list" class="cate-list" style="text-align: center; padding: 0 6px 0 6px;"></ul>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">라이센스
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="file multi">
                                <input type="file" name="productFile" class="btn-red;">
                                <button type="button" >검색</button>
                            </div>
                            <div class="file-list">
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="file multi">
                                <input type="file" name="openSourceFile" class="btn-red;">
                                <button type="button">검색</button>
                            </div>
                            <div class="file-list">
                            </div>
