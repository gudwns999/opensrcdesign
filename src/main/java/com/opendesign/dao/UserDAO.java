...
//////////////////////////////////////////////////김형준 수정_하루 중 처음 로그인 시 포인트 상//////////////////////////////////////////
	public int todayCheck(String email) {
		Date today = new Date();
		SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd");		
		// 포인트 추가.
		Map<String, Object> pMap = new HashMap<String, Object>();
		pMap.put("email", email);
		pMap.put("today",format.format(today));

		int point = sqlSession.selectOne(SQL_NS + "point", pMap);
		CmnUtil.setPoint(point);
		return (Integer) sqlSession.selectOne(SQL_NS + "todayCheck", pMap);
	}	
	public void todayPoint(String email){
		Date today = new Date();
		SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd");		
		// 포인트 추가.
		Map<String, Object> pMap = new HashMap<String, Object>();
		pMap.put("email", email);
		pMap.put("today",format.format(today));
		sqlSession.update(SQL_NS + "todayPoint", pMap);
	}
	public void updateLastDay(String email){
		//마지막 접속 일자로 수정.
		Date today = new Date();
		SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd");
		Map<String, Object> pMap = new HashMap<String, Object>();
		pMap.put("email", email);
		pMap.put("today",format.format(today));
		sqlSession.update(SQL_NS + "updateLastDay", pMap);
	}
//////////////////////////////////////////////////__김형준 수정_하루 중 처음 로그인 시 포인트 상//////////////////////////////////////////
