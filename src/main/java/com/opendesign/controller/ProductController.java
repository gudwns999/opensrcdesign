...
public class ProductController {
	...
	//----------------------------김형준 수정-----------------------------------//
	@RequestMapping(value = "/productStemRegi.do")
	public ModelAndView productStemRegi(HttpServletRequest request) {
		ModelAndView view = new ModelAndView("product/product_stem");
		view.addObject("cateList", commonService.selectCategoryListDepth1());
		return view;
	}
	
	@RequestMapping(value = "/getOriginLicense.ajax")	
	public @ResponseBody Map<String, Object> productgetOriginLicense(HttpServletRequest request) {
		Map<String, Object> resultMap = new HashMap<String, Object>();
		String license = service.getLicense(request.getParameter("origin"));
	...
	//////////////김형준 수정////////
	@RequestMapping(value = "/productOriginView.do")
	public ModelAndView productOriginView(@ModelAttribute DesignWorkVO dsWorkVO, HttpServletRequest request) {

		Map<String, Object> resultMap = designerService.productView(dsWorkVO, request);
		resultMap.put("schMemberDiv", MemberDiv.PRODUCT); // 회원구분
		return new ModelAndView("/product/product_originView", resultMap);
	}
	//////////_///////////////////
	/**
	 * <pre>
