...
/////////////////////////////////////////////////김형준////////////////////////////////////////////
		int cnt2 = dao.todayCheck(userVO.getEmail());
		CmnUtil cmm = new CmnUtil();		
		if(cnt2==0){
			//오늘 하루중 이미로그인 했었음 .
			cmm.setTodayLogin(true);
		}else{
			cmm.setTodayLogin(false);			
			//1회 처음 로그인 시 포인트 추가
			dao.todayPoint(userVO.getEmail());			
			//마지막으로 접속한 날을 오늘로 수정
			dao.updateLastDay(userVO.getEmail());
		}
/////////////////////////////////////////////////__김형준////////////////////////////////////////////
