						...
						<table class="tbl-regi">
							...
							<tr>
								...
								<td colspan="3" id="cateWrapProdMod">
									<div class="select-area custom-select" id="fisrtCateDiv" style="display:inline;">
										<input type="text">
									...
									<div class="select-area custom-select" style="display:inline">
										<input type="text">
									...
									<ul class="cate-list" style="display:none">
										<%
